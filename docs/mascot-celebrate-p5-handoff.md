...
- 每隻手只使用一個完整圓潤墨滴端點，不設手指、凹口、分叉或愛心形；
- 墨冠隨跳躍向上及向外伸展，獨立墨滴跟隨上升；
- 不使用星星、彩帶、煙花、勾號、獎盃或文字作主要訊號。

v1 因開口過高、手臂與手掌過大，在 34 / 42px 有驚訝／尖叫及巨手風險而被淘汰。v2 改善比例與嘴形，但分叉手掌仍像手套／愛心；v3 改用單一圓形墨滴手。後續不可回退為 O 形嘴、巨手或分叉手指。
...
不得讀成尖叫、失控、炫耀、打敗別人或「只有滿分才值得高興」。若嘴形像驚訝／尖叫、圓手黏成雜亂輪廓、手部壓過臉部或動勢造成感官負荷，直接 fail。

### Gate D — Size QA
檢查 34 / 42 / 48 / 64 / 96 / 160px。34 / 42px 特別確認：圓眼及開口笑仍分開；雙手不遮臉；騰空輪廓不退化成雜亂墨團。
