...
function newerRecord(a,b){const left=a&&typeof a==='object'?a:{},right=b&&typeof b==='object'?b:{},la=Number(left.attempts)||0,ra=Number(right.attempts)||0;if(la!==ra)return la>ra?left:right;const lt=timeValue(left.lastAnsweredAt||left.updatedAt),rt=timeValue(right.lastAnsweredAt||right.updatedAt);return rt>lt?right:left}
...
const api={LEARNING_KEY,ROTATION_KEY,timeValue,newerRecord,mergePracticeHistory,mergeLearningState,mergeRotation,mergeGame,syncNow,schedule,clearLocal,install};
