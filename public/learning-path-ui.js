...
function install(){
 ...
 const learning=engine();if(learning&&!learning.__pathWrapped){['submit','syncRemoteResult'].forEach(name=>{const original=learning[name];if(typeof original!=='function')return;learning[name]=function(){const result=original.apply(this,arguments);render();return result}});learning.__pathWrapped=true}render();
}
