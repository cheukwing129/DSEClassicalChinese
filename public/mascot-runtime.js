...
const STATE_LIST=Object.freeze([
  ...
  Object.freeze({id:'thinking',label:'思考',asset:'./mascot/moling-thinking.svg',intent:'提示、概念理解、重新教學',motion:'static-or-fade',artStatus:'candidate',productionPriority:3}),
