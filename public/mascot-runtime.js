...
const STATE_LIST=Object.freeze([
  ...
  Object.freeze({id:'celebrate',label:'慶祝',asset:'./mascot/moling-celebrate.svg',intent:'全對、完成一課、解鎖重要內容',motion:'single-celebration',artStatus:'candidate',productionPriority:5}),
