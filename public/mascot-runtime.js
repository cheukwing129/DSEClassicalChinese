...
const STATE_LIST=Object.freeze([
  ...
  Object.freeze({id:'determined',label:'堅定',asset:'./mascot/moling-determined.svg',intent:'連續學習、streak、每日目標',motion:'static-or-short-lift',artStatus:'candidate',productionPriority:4})
]);
