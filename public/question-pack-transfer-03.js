...
const questions=[
 ...
 {id:'tr3q006',kpId:'kp_virtual_wei',textId:'CROSS',skillIds:['fw.wei'],sourceTextId:'lianpo',sourceSentenceId:'sentence:lianpo:xiangyu-huan-wei-wenjing',sourceKind:'classical-canon',transferLevel:2,type:'choice',q:'《廉頗藺相如列傳》「卒相與歡，為刎頸之交」中的「為」最接近？',o:['成為','被','替','因為'],a:'成為',explanation:'句子說廉頗與藺相如最終和好，成為生死之交；「為」在此表示「成為」。'},
