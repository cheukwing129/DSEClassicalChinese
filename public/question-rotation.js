...
const api={KEY,MAX_PER_KP,SENTENCE_HISTORY_KEY,MAX_SENTENCES,idOf,kpOf,sentenceOf,recentIds,recentSentenceIds,remember,rank,select,choose,rememberNode,install,clear};
