...
test('Stage 3 production smoke validates deployed pack runtime rotation and summary',()=>{
...
test('Pages deployment wait includes Stage 3 runtime loader and expanded question pack',()=>{
  const workflow=read('.github/workflows/pages-production-smoke.yml');
